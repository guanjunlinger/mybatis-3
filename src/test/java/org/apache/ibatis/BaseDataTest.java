...
public abstract class BaseDataTest {
  ...
  public static final String MYBATIS_PROPERTIES = "org/apache/ibatis/databases/mybatis/mybatis-mysql.properties";
  ...
  public static DataSource createMybatisDataSource() throws IOException, SQLException {
    DataSource ds = createUnpooledDataSource(MYBATIS_PROPERTIES);
    runScript(ds, BLOG_DDL);
    runScript(ds, BLOG_DATA);
    return ds;
  }
